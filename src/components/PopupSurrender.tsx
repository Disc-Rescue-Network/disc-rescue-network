...
const PopUpSurrender: React.FC<PopupReportProps> = ({ title, content, onClose, className }) => {
    ...
    return (
        <div  className={`popup ${className}`} style={{ display: 'flex', flexDirection: 'column' }}>
            <div className="popup-content">
                <span className="close" id="close" onClick={onClose}>
                    <div className='line'></div>
                    <div className="line"></div>
                </span>
                <h2 className='header-surrender-disc'>
                    {title}
                </h2>
