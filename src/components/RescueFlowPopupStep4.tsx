    ...
    return (
        <div className="popup" id="popup-verify" style={{ display: 'flex', flexDirection: 'column' }}>
            <div className="popup-content" id="popup-verify-content" style={{ padding: '10px 5px' }}>
                <div className="course-section-popup" style={{ margin: '0', width: '100%' }}>
                    <div className="row" 
                        style={{ 
                        ...
                        >
                            <div className="col-6-step4 disc-item" style={{ paddingRight: '5px', paddingLeft: '5px' }}>
                                <CardsRescueFLow 
                           ...
                           <div className="col-6-step4 disc-item" style={{ paddingRight: '5px', paddingLeft: '3.5px' }}>
                                <CardsRescueFLow 
                                    Course={"Tranquility Trails"} 
                                    img={imageLogo} 
                                    Color={"Green"} 
                           ...
                           <div className="col-6-step4 disc-item" style={{ paddingRight: '3.5px', paddingLeft: '3.5px' }}>
                                <CardsRescueFLow 
                                    Course={"Tranquility Trails"} 
                                    img={imageLogo} 
                                    Color={"Green"} 
