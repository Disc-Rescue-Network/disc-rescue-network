...
const FormClaimDisc = (props: FormClaimDiscProps) => {
    const { inputInicial, inputName, inputPhone, inputPickupLocation } = props;
    return (
        <>
          <div className="select-box" style={{ marginBottom: '0.5rem', marginTop: '0.5rem'}}>
            <div className="col-4 arrow one" >
                <select className="form-select" style={{ height: '55px !important' }}>
                <option value="All">{inputInicial}</option>
                </select>
            </div>
          ...
          <div className="select-box" style={{ marginBottom: '0.5rem', marginTop: '0.5rem'}}>
            <div className="col-12 pe-0 arrow one">
                <select className="form-select" style={{ width: '100%', maxWidth: '600px'}}>
