      ...
      <div className="fab-menu-container" id="fabMenuContainer">
        <div className="fab-menu" id="fabMenu">
          <div className="fab-menu-item">
            <a className="fab-menu-item-text-left" href="/reportLostDisc">
              Report <br /> Lost Disc
            </a>
            <i
          ...
          <div className="fab-menu-item">
            <a className="fab-menu-item-text" href="/requestCourse">
              Request a Course
            </a>
            <i
          ...
          <div className="fab-menu-item">
            ...
            <a className="fab-menu-item-text-right" href="/settings">
              Settings
            </a>
          </div>
        </div>
